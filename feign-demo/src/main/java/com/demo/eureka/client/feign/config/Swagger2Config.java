package com.demo.eureka.client.feign.config;
...
public class Swagger2Config {
	...
	public Docket createRestApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()		//控制要暴露的接口
				.apis(RequestHandlerSelectors.basePackage("com.demo.eureka.client.feign.controller"))	//通过指定扫描包暴露接口
